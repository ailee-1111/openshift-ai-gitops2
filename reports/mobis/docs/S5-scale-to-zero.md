...
>
> **구축 런북**: runbooks/340 | **검증 런북**: runbooks/540 | **IaC**: poc/scale-to-zero/
>
> **결과**: 2/2 PASS (100%)
...
- runbooks/340-scale-to-zero.md
- runbooks/540-scale-to-zero-validation.md
...
## v3 강화 (341-scale-to-zero-v3)

- 5회 반복 Cold Start 평균/분산 측정
- 전체 사이클 (축소→요청→복원→추론→재축소)
- 8B 모델(qwen3-8b) Cold Start 측정
- 구축 런북: 341-scale-to-zero-v3.md | 검증: 540 v3 섹션
