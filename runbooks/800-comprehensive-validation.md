...
S1~S10 시나리오별 검증 결과를 취합하고, 시나리오 횡단 테스트(동시 부하, E2E 흐름)를 수행한 뒤, `reports/{customer}/` 산출물을 생성한다.

## 전제 조건

- [ ] `runbooks/500~590` 시나리오별 검증 완료
...
echo ""
echo "S3 Auto-scaling (runbooks/520):"
echo "  V-21 HPA 스케일업:       [   ]"
echo "  V-22 GPU 메트릭:         [   ]"
echo "  V-25 정책 커스터마이징:  [   ]"
echo ""
echo "S4 장애복구 (runbooks/530):"
echo "  V-26 다중 레플리카:      [   ]"
echo "  V-27 자동 복구:          [   ]"
echo "  V-28 노드 페일오버:      [   ]"
echo "  V-29 무중단 교체:        [   ]"
echo ""
echo "S5 Scale-to-Zero (runbooks/540):"
echo "  V-23 스케일 투 제로:     [   ]"
echo "  V-24 콜드스타트:         [   ]"
echo ""
echo "S6 운영관리 (runbooks/550):"
...
- **횡단 테스트 실패** → 개별 시나리오 런북(500~590)으로 돌아가 실패 항목 재확인.
